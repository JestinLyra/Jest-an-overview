...
function renderHome(){
 ...
 <section class="section home-secondary-tracker-shell" style="--secondary-tracker-count:1" aria-label="Meals tracker"><div class="home-secondary-tracker-art" aria-hidden="true"></div><div class="home-secondary-tracker-zones"><button class="home-secondary-tracker-zone" aria-label="Meals" onclick="openMeals()"></button></div></section>
 <section class="section home-lifestyle-tracker-shell" aria-label="Wellness and activity trackers"><div class="home-lifestyle-tracker-art" aria-hidden="true"></div><div class="home-lifestyle-tracker-zones"><button class="home-lifestyle-tracker-zone" aria-label="Wellness Checks"></button><button class="home-lifestyle-tracker-zone" aria-label="Active Days"></button></div></section>
